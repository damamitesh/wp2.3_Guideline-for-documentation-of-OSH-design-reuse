# Introduction
<details>
<summary>Click to see the guidelines and examples </s
<br>
- Find a tl;dr guide (two-pager) on lincensing and IPR [here](https://github.com/OPEN-NEXT/tldr-ipr) and more extensive guide [here](https://github.com/OPEN-NEXT/OKH-LOSH/blob/master/OTRL.md)
